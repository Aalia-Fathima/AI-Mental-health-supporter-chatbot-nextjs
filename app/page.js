...
export default function Home() {
  ...
  const handleSendMessage = async (msg) => {
    ...
    const response = await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/chat`, { message: msg });
  ...
  const handleClear = async () => {
    await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/clear`);
    setChatHistory([]);
    setShowPrompts(true);
  };
